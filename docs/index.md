...
<div style="display: grid; grid-template-columns: 3fr 1fr;">
   ...
   <div style="display: flex; justify-content: center;">
       <img src="/static/img/logo/combattingbias.png" alt="Combatting Bias logo" title="The project logo is designed by Jan-Pieter Karper." style="width: 100%; max-width: 200px;" />
   </div>
</div>

<div style="display: flex; align-items: center; gap: 20px; margin-top: 20px;">
   <img src="/static/img/TDCC-SSH-Logo_RGB.png" alt="TDCC-SSH logo" style="width: 100px;" />
   <p><em>Combatting Bias is funded by the Dutch Research Council (NWO) via the Thematic Digital Competence Centre Social Sciences & Humanities (TDCC-SSH). For more information about the TDCC-SSH, please visit their <a href="#">website</a>.</em></p>
</div>
