...
Central to our project - and to the SSH as well as ML fields, we argue - is the need to scrutinise the term 'bias': **what do we mean with the concept 'bias'**? 
...
<div style="float: right; margin: 10px 0 10px 25px; max-width: 400px;">
